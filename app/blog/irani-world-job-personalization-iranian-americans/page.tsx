      ...
      <main className="container flex flex-col lg:flex-row">
        <div className="w-full lg:w-5/6 pt-16 mt-20 lg:mt-0">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/images/thumbnails/iu-2-cover.jpg')`,
            }}
          ></div>
          <div className="w-full flex gap-x-14 my-10">
            ...
            <div className="flex flex-col gap-y-12">
              <p className="text-white-shade-10 text-xl leading-8">
                Greetings dear readers and future users of the Irani.World
                project! We're excited to introduce the latest development in
                our global project – the{" "}
                ...
                : Your Gateway to New Opportunities At Irani.World, our mission
                is to connect people, jobs, and expertise in a way that is
                efficient and personal. We understand the unique challenges and
                opportunities that Iranian Americans face, and we've crafted
                this platform to cater to your specific needs.
              </p>
            </div>
          </div>
          <div
            ...
            style={{
              backgroundImage: `url('/images/thumbnails/iu-1-cover.jpg')`,
            }}
          ></div>
          <div className="w-full flex flex-col gap-x-14 my-10 pb-22 border-b border-white-shade-2">
            <div className="flex gap-x-10 mb-10">
              ...
              <div className="flex flex-col gap-y-3">
                <h2 className="font-semibold font-outfit text-3xl text-black my-4">
                  What to Expect from IraniUSA.com
                </h2>
                <h4 className="font-semibold font-outfit text-2xl text-black">
                  1. Tailored Job Listings
                </h4>
                <p className="text-white-shade-10 text-xl leading-8">
                  IraniUSA.com features a comprehensive job search and listing
                  portal, specifically curated for Iranian-Americans. Whether
                  you're seeking employment or looking to hire, you'll find
                ...
                <p className="text-white-shade-10 text-xl leading-8">
                  Creating your professional profile on IraniUSA.com allows you
                  to showcase your talents, qualifications, and experience in a
                  way that resonates with potential employers. We make sure your
                  profile stands out in the crowd.
                </p>
                <h4 className="font-semibold font-outfit text-2xl text-black">
                  3. Networking Opportunities{" "}
                </h4>
                <p className="text-white-shade-10 text-xl leading-8">
                  Connect with like-minded professionals, mentors, and industry
                  experts within the Iranian American community. Build a
                  powerful network that can help you advance your career and
                  achieve your goals.
                </p>
                ...
                <p className="text-white-shade-10 text-xl leading-8">
                  ...
                  interests, delivering personalized job recommendations,
                  relevant articles, and more to your dashboard. We want to make
                  sure you're always up-to-date with the latest trends in your
                  field.
                </p>
                ...
                <p className="text-white-shade-10 text-xl leading-8 pb-4 border-b border-white-shade-7">
                ...
                <p className="text-white-shade-10 text-xl leading-8 my-7">
                  ...
                  provide a dedicated space for Iranian Americans. This
                  community holds a unique place in the American tapestry,
                  contributing to various industries and bringing their skills,
                  knowledge, and talents to the forefront.
                  <br />
                  <br />
                  We believe that the Iranian American community deserves a
                  platform that understands their unique requirements,
                  challenges, and aspirations. IraniUSA.com is our commitment to
                  serving this vibrant and dynamic group of individuals.
                  <br />
                  <br />
                  Stay Tuned for the Grand Launch The American section of
                  Irani.World, www.iraniusa.com, will soon be unveiled, and we
                  can't wait for you to experience the wealth of opportunities
                  and resources it offers. Whether you're a recent graduate, a
                  seasoned professional, or an employer looking for top talent,
                  IraniUSA.com is the place for you.
                  <br />
                  <br />
                  Keep an eye on our blog and social media channels for updates
                  on the official launch date and exciting features that await
                  you. We're confident that this platform will become an
                  invaluable asset for the Iranian American community in the
                  United States.
                  <br />
                  <br />
                  Irani.World and IraniUSA.com are dedicated to helping you
                  thrive in your career and personal journey. We look forward to
                  supporting your dreams and ambitions on this exciting new
                  platform. Stay tuned and get ready for a new era in job

        ...
        <div className="w-full lg:w-5/6 pt-16 lg:mt-0 mt-16">
          ...
          <div className="w-full flex flex-col lg:flex-row gap-y-6 gap-x-6 mb-10">
            ...
            <NewsCard
              ...
              title={"Why should you use and invest time in the Irani.World ? "}
              summery={

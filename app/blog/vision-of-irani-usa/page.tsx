        ...
        <div className="w-full lg:w-4/5 pt-16">
          ...
          <div className="w-full flex gap-x-14 my-10">
            ...
            <div className="flex flex-col gap-y-12">
              <p className="text-white-shade-10 text-xl leading-8">
                In the world of web design and development, there are stories
                that stand out as inspiring examples of creativity, dedication,
                and collaboration. The tale of RIV Design Company is one such
                story, where a team of eight talented individuals embarked on a
                remarkable journey to bring the vision of Irani USA to life. In
                this blog post, we'll delve into the fascinating journey of how
                RIV Design Company played a pivotal role in designing and
                developing the entire Irani USA platform, from its inception to
                its fully functional website.
                <br />
                <br />
                Team Collaboration RIV Design Company, comprised of eight
                talented individuals with diverse skills, immediately recognized
                the potential and importance of Irani USA's mission. Their team
                collaboration was the cornerstone of this project's success.
                They held brainstorming sessions to ensure they understood the
                platform's goals, target audience, and unique selling points.
              </p>
            </div>
          </div>
          <div
            ...
            style={{
              backgroundImage: `url('/images/thumbnails/riv-post-1.jpg')`,
            }}
          ></div>
          <div className="w-full flex flex-col gap-x-14 my-10 pb-24 border-b border-white-shade-4">
            <div className="flex gap-x-10 mb-10">
              ...
              <div className="flex flex-col gap-y-12">
                <p className="text-white-shade-10 text-xl leading-8">
                  Development The development phase was the technical backbone
                  of Irani USA. The RIV team used cutting-edge technologies to
                  build a robust, scalable, and secure platform. They paid
                  meticulous attention to detail, ensuring that the website
                  would perform seamlessly even as it grew.
                </p>
              </div>
            </div>

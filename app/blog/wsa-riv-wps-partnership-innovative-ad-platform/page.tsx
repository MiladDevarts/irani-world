  ...
  return (
    <>
      ...
      <main className="container flex flex-col lg:flex-row">
        <div className="w-full lg:w-5/6 pt-16 mt-20 lg:mt-0">
          <div className="w-full flex flex-col items-start lg:items-center mb-10">
            <h1 className="text-left text-black font-outfit text-3xl font-semibold lg:text-center max-w-xl">
              ...
              WPS Association for Innovative Advertising Platform
            </h1>
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/images/thumbnails/wsa-cover.jpg')`,
            }}
          ></div>
          <div className="w-full flex gap-x-14 my-10">
            ...
            <div className="flex flex-col gap-y-12">
              <p className="text-white-shade-10 text-xl leading-8">
                In a significant leap forward for the world of advertising and
                marketing, WSA Company is proud to announce its forthcoming
                collaboration with industry leaders RIV Company and the WPS
                Association. This partnership is set to revolutionize the way
                companies and experts promote themselves, bringing forth a
                groundbreaking advertising platform that promises to disrupt the
                status quo.
                <br />
                <br />
                The Power of Collaboration: At WSA Company, we firmly believe
                that collaboration is the key to innovation. We recognize the
                importance of joining forces with like-minded organizations that
                share our commitment to excellence and cutting-edge solutions.
                Our partnership with RIV Company and the WPS Association
                exemplifies this philosophy, as we pool our resources,
                expertise, and creative energy to create something truly
                extraordinary.
                <br />
                <br />
                RIV Company: Elevating Digital Advertising RIV Company, known
                for its prowess in digital advertising, is set to play a pivotal
                role in this collaboration. With a track record of driving
                results through data-driven strategies, RIV Company brings a
                wealth of experience in understanding consumer behavior and
                trends. Their insights will be instrumental in helping
                businesses connect with their target audiences effectively.
                <br />
                <br />
                WPS Association: Empowering Experts The WPS Association is
                renowned for its commitment to empowering experts across various
                industries. By partnering with them, we are opening up new
                avenues for professionals to showcase their expertise and
                connect with potential clients. The association's vast network
                and knowledge-sharing capabilities will be leveraged to offer an
                unmatched platform for experts to shine.
                <br />
                <br />A Glimpse into the Future: The forthcoming advertising
                platform, born out of this alliance, will be a dynamic hub where
                companies and experts can collaborate, share their stories, and
                engage with their audiences in innovative ways. Here's a sneak
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/images/thumbnails/wsa-post-1.jpg')`,
            }}
          ></div>
          <div className="w-full flex flex-col gap-x-14 my-10 pb-24 border-b border-white-shade-4">
            <div className="flex gap-x-10 mb-10">
              ...
              <div className="flex flex-col gap-y-12">
                <p className="text-white-shade-10 text-xl leading-8">
                  Targeted Advertising: Utilizing RIV Company's expertise, the
                  platform will offer advanced targeting options to ensure that
                  your message reaches the right audience at the right time.
                  <br />
                  <br />
                  Expert Insights: Experts from various fields will have a
                  dedicated space to share their knowledge, insights, and
                  thought leadership, further enhancing their credibility.
                  <br />
                  <br />
                  Community Building: The platform will foster a vibrant
                  community where businesses and experts can connect,
                  collaborate, and grow together.
                  <br />
                  <br />
                  Conclusion: As we embark on this exciting journey with RIV
                  Company and the WPS Association, we invite you to stay tuned
                  for updates on our upcoming advertising platform. This
                  collaboration is set to redefine the advertising landscape,
                  empowering companies and experts to reach new heights.
                  Together, we will unleash the full potential of advertising,
                  bridging the gap between businesses and their target audiences
                  like never before. The future of advertising has arrived, and
        ...
        <div className="lg:relative w-full lg:w-1/6 lg:h-screen">
          <div className="lg:fixed w-full h-full pt-16 lg:ml-4">
            <div className="flex flex-col mx-0 lg:mx-5">
            ...
            <div className="flex flex-col lg:mx-5 mt-6">
              <h3 className="text-2xl font-outfit font-semibold text-black mb-4">
                Tags
              </h3>

  ...
  return (
    <main className='flex container h-full'>
      <section className='w-1/3'>
        <div>
          <span className='inline-block p-4 text-sm rounded-full font-opensans text-black bg-white mt-20 mb-6 shadow-badge'> 🎉 Made for persian people</span>
          ...
          <p className='max-w-sm text-lg text-white-shade-8 my-6 font-light'>
            Terms and conditions outline what users can and cannot do with your
          </p>
          <div className='flex gap-x-2'>
            <Link className='inline-flex justify-center items-center font-opensans font-medium rounded-2xl bg-[#011223] text-center p-3 w-40 h-12' href="/">
              Our platform
            </Link>
      ...
      <section className='w-1/3 h-full bg-black'>

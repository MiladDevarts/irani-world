...
const BlogCard: React.FC<BlogCardProps> = (props) => {
  return (
    <>
      <Link href={"#"}>
        <div
          className={`${props.classes}w-1/2 border-[1.5px] border-white-shade-3 rounded-2xl p-1 hover:shadow-card transition-all duration-300 `}
        >
          <div className="w-2/3 flex flex-col gap-y-5 p-5">
            ...
            <h1 className="text-black text-xl font-outfit font-semibold lg:max-w-sm lg:text-xl">
             {props.title}
            </h1>
            <p className="font-opensans text-white-shade-11 font-medium text-sm lg:max-w-xs">
           {props.summery}
            </p>
            <div>
          ...
          <div
            className="w-1/3 h-full bg-black bg-cover bg-center rounded-2xl"

...
const ContactMethods:React.FC<ContactMethods> = (props) => {
  return (
    <div className={`${props.classes} w-full  flex-col gap-y-6 mt-6 border border-white-shade-4 rounded-3xl p-8`}>

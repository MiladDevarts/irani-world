      ...
      <section className='w-full lg:w-1/3 pt-20 lg:pt-10'>
        ...
        <div>
          ...
          <div className='flex gap-x-2'>
            <Link className='btn-flashing-animation inline-flex justify-center items-center font-opensans font-medium rounded-2xl bg-[#011223] text-center p-3 w-40 h-12 hover:bg-[#333b44] transition-all' href="/">
              Our platform
            </Link>
            <Link className='inline-flex justify-center items-center font-opensans bg-white-shade-3 font-medium rounded-2xl text-center p-3 w-10 h-12' href="/">
              <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.79981 1.14999C2.49605 1.14999 2.24981 0.903744 2.24981 0.599988C2.24981 0.296231 2.49605 0.0499878 2.79981 0.0499878H9.39981C9.70356 0.0499878 9.94981 0.296231 9.94981 0.599988V7.19999C9.94981 7.50375 9.70356 7.74999 9.39981 7.74999C9.09605 7.74999 8.84981 7.50375 8.84981 7.19999V1.92781L0.988713 9.7889C0.773925 10.0037 0.425684 10.0037 0.210896 9.7889C-0.00389241 9.57411 -0.00389241 9.22587 0.210896 9.01108L8.07199 1.14999H2.79981Z" fill="#B3B3B3" />
              </svg>
            </Link>
          </div>
        </div>
        ...
        <div className='flex gap-x-10 mt-20'>
          <div className=''>
            <h4 className='text-black font-outfit text-2xl font-semibold'>3,452k</h4>
            <span className='font-opensans text-white-shade-8'>Followers</span>
          </div>
          <div className=''>
            <h4 className='text-black font-outfit text-2xl font-semibold'>600</h4>
            <span className='font-opensans text-white-shade-8'>Followers</span>
          </div>
        </div>

        <div className='flex gap-x-2 mt-10'>
          <Image src={"/images/home/latest-users.png"} className='w-auto' width={100} height={60} alt={"Irani World"} />
          <div className='flex flex-col justify-center gap-y-3'>
            <h4 className='text-black font-outfit text-2xl font-semibold'>+10M users</h4>
            <span className='font-opensans font-medium -mt-4 text-white-shade-8'>From all around the world</span>
          </div>
        </div>

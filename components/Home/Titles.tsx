      ...
      <section className="w-full lg:w-1/3 pt-20 lg:pt-10">
        ...
        <div>
          ...
          <div className="flex gap-x-2">
            <Link
              className="btn-flashing-animation inline-flex justify-center items-center font-opensans font-medium rounded-2xl bg-[#011223] text-center p-3 w-40 h-12 hover:bg-[#333b44] transition-all"
              href="/"
            >
              Our platform
            </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-x-4 gap-y-4 mt-10 lg:mt-28 items-center">
          <Image
          ...
          <div className="flex flex-col gap-y-6 order-1 lg:order-2">
            ...
            <div className="flex gap-x-10 order-1 lg:order-2 text-center lg:text-left">
              <div className="">
                ...
                <span className="font-opensans text-white-shade-8">
                  Followers
                </span>
              </div>

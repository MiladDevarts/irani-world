...
const Navigation: React.FC<NavigationProps> = (props) => {
  ...
  return (
    <nav className="z-[1013] bg-white lg:h-[8vh] shadow-deep absolute top-0 lg:top-[92%] w-full border-none lg:border-t border-white-shade-4 dark:border-[#293446] soft-shadow">

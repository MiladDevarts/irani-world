...
const Navigation = () => {
  ...
  return (
    <nav className="z-[1013] bg-white dark:bg-[#1a202c] shadow-deep absolute bottom-[90%] lg:bottom-0 w-full h-[10vh] border-t border-white-shade-4 dark:border-[#293446] soft-shadow">
